  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Built 1897. Rebuilt around comfort, cooking and quiet ever since."
        image={IMG.exterior}
      />
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-24">
          <FadeUp>
            ...
            <h2 className="mt-5 font-heading text-4xl font-medium leading-tight text-ink md:text-5xl">
              1897 to now, lightly edited
            </h2>
          </FadeUp>
          <FadeUp delay={0.1}>
            <div className="space-y-5 font-body text-base font-light leading-body text-ink/80">
              <p>
                Selkie Bay was built as a private house for a Dundee jute baron with more money
                than restraint, which explains the turret. For a century it hosted golfing
                parties, jealous cousins and at least one scandal the town still references.
              </p>
              <p>
                The present custodians bought the house in 2019 and spent three years doing the
                unglamorous things first — roof, pipes, kitchen — before opening eighteen rooms in
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-24">
            ...
            <FadeUp delay={0.15}>
              ...
              <div className="mt-6 space-y-5 font-body text-base font-light leading-body text-ink/80">
                <p>
                  We heat the house with an air-source system fed by the harbour wind, collect
                  rainwater off the old slate roof, and grow a meaningful share of the kitchen’s
                  vegetables inside the 1868 wall. What we cannot grow, we buy within forty miles
                  where the quality allows — and it usually does.
                </p>
                <p>
                  No single-use plastics in the rooms, two EV chargers in the courtyard, and a
                  dune-restoration plan along the shore that the oystercatchers have opinions
                  about. We publish the numbers annually rather than the slogans.
                </p>
              </div>
            </FadeUp>
          </div>
